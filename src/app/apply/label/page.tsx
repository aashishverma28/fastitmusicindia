    ...
    <div className="min-h-screen py-24 px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="mb-12">
          <Link 
            href="/apply" 
            className="flex items-center gap-2 text-foreground/45 hover:text-secondary transition-colors font-bold"
          >
        ...
        >
          <h1 className="text-4xl md:text-6xl font-black font-display text-foreground mb-6 tracking-tighter">
            Record Label <span className="text-secondary">Application</span>
          </h1>
          <p className="text-foreground/60 text-lg max-w-2xl mx-auto font-sans">
